...
def get_imageID(term, page):
    try:
        print('获取图片ID.....')
        url = 'https://stock.tuchong.com/api/search/?term=' + term + '&page=' + str(page)
...
def save_image(content):
    img_dir = 'C:/Users/19482/Desktop/wrr/tu/face'
    file_path = '{0}/{1}.{2}'.format(img_dir, md5(content).hexdigest(), 'jpg')
